  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 shadow-sm">
      ...
      <div className="bg-[#de1c0e] text-white py-1.5 px-4 text-center text-xs font-medium hidden md:block">
        Genuine TVS Parts &amp; Accessories — Free shipping above ₹999 — 1 Year
            ...
            {isLoggedIn ? (
              <div className="relative" ref={userRef}>
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-3.5 h-3.5 text-gray-500 hidden md:block transition-transform ${showUserMenu ? "rotate-180" : ""}`}
                  />
                </button>
                ...
                {showUserMenu && (
                  <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
                    ...
                    {/* ── My Orders → /profile?tab=orders (no separate page) ── */}
                    <Link
                    ...
                    {user?.role === "admin" && (
                      <Link
                        to="/admin"
                        className="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 text-sm text-[#0a1f44] font-semibold transition-colors"
                      >
            ...
            <div className="relative hidden md:block" ref={moreRef}>
              ...
              {showMoreMenu && (
                <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
                  <Link
                    to="/become-seller"
                    className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 text-sm text-gray-700 border-b border-gray-50 transition-colors"
                  >
